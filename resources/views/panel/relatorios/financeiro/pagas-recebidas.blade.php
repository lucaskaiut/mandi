...
@section('content_header')
    <h1 class="title-h1">Relatório de Contas Pagas x Recebidas</h1>
@stop
...
@section('content')
    <div class="main-box">
        <div class="box-body">
            <div class="col-lg-12">
                <form target="_blank" class="form-group" action="{{route('relatorios.pagas.recebidas.list')}}" method="POST">
                    {{csrf_field()}}
